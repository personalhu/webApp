define(function(require){
	return commonObj = {
        ...
        getData: function (pagenumber) {
            $.ajax({
                type: "get",
                url: "/weixinshangcheng/static/script/test.json",
                data: {
        ...
        addcatAnimation:function(e){
        	e.stopPropagation();
        	var number = Number($("#cartnumbers").val());
        	var productimg=$("#productimg");
        	var imgsrc = $("#productimg").children("img").attr("src");
        	console.log(imgsrc);
        	var x = productimg.offset().left+30;
        	var y = productimg.offset().top-10;
         ...
         set_address:function(){
                    var addr_id = $("input[name='adress_options']:checked").val();
        ...
        set_invoice:function(){
       		var involice = $('#is_set').is(":checked");
       		if(involice){
